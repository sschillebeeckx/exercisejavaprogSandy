...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n------------------------ExB5.4 Request offer for Session----------------------------------");

        System.out.println("-----------------using 2 catch blocks------------------------");
        try {
            //double offer =comp2.requestPriceOfferForCompanySession(course2,2);
        ...
        try {
            ...
            System.out.println("The price offer for  " + course2 +  " is "  +offer +".");
        } catch (PriceTooHighException | PriceTooLowException e) {
            System.out.println(e.getMessage());
        }
    }
}
