...
public class PublicSession extends Session {
    ...
    public PublicSession(Course course, LocalDate startDate, Company location, Person instructor) {
    ...
    public void printParticipantList(){
        System.out.println("Participant list for the " + this.getCourse() + " course on " + DateUtils.format(this.getStartDate()) + ":\n");
