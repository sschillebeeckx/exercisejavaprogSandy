...
public class Test123 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<CourseParticipant> sortedFirstName = es.sortParticipantsByFirstName(enrolments);
            sortedFirstName.forEach(System.out::println);

            System.out.println("\n------------------------ExB9.3  Participant List sorted on last name----------------------------------");
            List<CourseParticipant> sortedLastName = es.sortParticipantsByLastName(enrolments);
